...
void appRunner(AppConfig appConfig) async {
  ...
  final authState = await AuthState(httpClient, localStorage, notifications).init();
...
class MyApp extends StatelessWidget {
  ...
  Widget build(context) {
    ...
    return  MaterialApp(
      ...
      initialRoute: authState.currentUser != null ? RootScreen.ROUTE : LoginScreen.ROUTE,
      ...
      supportedLocales: appConfig.locales.values.map((l) => l.toFlutterLocale()),
    );
  }
}
