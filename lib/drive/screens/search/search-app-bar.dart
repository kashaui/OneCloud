...
AppBar searchAppBar(BuildContext context, {TextEditingController controller, FocusNode focusNode}) {
  return AppBar(
...
class _TextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final folderName = context.select((DriveState s) => s.activePage.folder?.name);
    return TextField(
...
class _CloseButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final queryIsEmpty = context.select((DriveState s) => s.activePage.staticQueryParams['query'] == null);
    return queryIsEmpty ? Container() : IconButton(
