...
class AppConfig {
  ...
  Future<AppConfig> init() async {
    ...
    httpClient = AppHttpClient(localConfig.baseBackendUrl, localConfig.apiVersion);
  ...
  _initWithDefaultValues() async {
    ...
    final decoded = json.decode(await rootBundle.loadString('assets/config/themes.json'));
