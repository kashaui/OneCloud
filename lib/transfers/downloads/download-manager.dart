...
typedef DownloadManagerCallback<T> = void Function(DownloadTaskStatus status, int progress, String taskId);
...
class DownloadManager {
  ...
  Future<String> enqueue(FileEntry entry, String destination, {DownloadManagerCallback callback}) async {
  ...
  Future<String> restart(FileTransfer transfer) async {
    final oldTaskId = transfer.taskId;
    final oldTask = (await FlutterDownloader.loadTasks()).firstWhere((t) => t.taskId == oldTaskId);
